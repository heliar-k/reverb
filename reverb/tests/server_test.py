...
from reverb import item_selectors, pybind, rate_limiters, server, signature_codec
...
class TableTest(parameterized.TestCase):
    ...
    @parameterized.product(
        sampler_fn=[
            ...
            lambda: item_selectors.Prioritized(1.0),
        ...
        rate_limiter_fn=[
            ...
            lambda: rate_limiters.SampleToInsertRatio(1.0, 10, 1.0),
