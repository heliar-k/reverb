...
class DefaultCheckpointer(CheckpointerBase):
    ...
    def __init__(
        self, path: str, group: str = "", fallback_checkpoint_path: Optional[str] = None
    ):
    ...
    def internal_checkpointer(self) -> pybind.Checkpointer:
        """Creates the actual Checkpointer-object used by the C++ layer."""
        return pybind.create_default_checkpointer(
            self.path, self.group, self.fallback_checkpoint_path
        )
