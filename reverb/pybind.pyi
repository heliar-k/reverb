...
class Client:
  ...
  def NewWriter(
      self, chunk_length: int, max_timesteps: int,
      delta_encoded: bool = ..., max_in_flight_items: int = ...) -> Writer: ...
  def NewSampler(
      self, table: str, max_samples: int, buffer_size: int) -> Sampler: ...
  def NewTrajectoryWriter(
      self, chunker_options: ChunkerOptions,
      validate_items: bool) -> TrajectoryWriter: ...
  def NewStructuredWriter(
      self, serialized_configs: Sequence[bytes]) -> "StructuredWriter": ...
...
class InProcessClient:
  ...
  def new_structured_writer(
      self,
      table: str,
      configs: Sequence[bytes]) -> "StructuredWriter": ...
